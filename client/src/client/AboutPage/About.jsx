...
Auction & Bid Information Real-Bid <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
                ...
                <li>
                  <a data-bs-toggle="collapse" data-bs-target="#accordion-list-2" className="collapsed"><span>02</span> Who can auction the property through Real-Bid <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
                  <div id="accordion-list-2" className="collapse" data-bs-parent=".accordion-list">
                    <p>
                    Any Individual, Institutions, Banks and Government Departments can auction the properties through Real-Bid. Individuals should provide all details that RBS may require in the manner in which it is required. Banks and Institutions can Real-Bid properties under relevant Acts and their rules. Unique user ID and password will be delivered to the Authorised Officer of the Bank/Institution only to ensure security. SLA will be executed between RBS & Institutions.
                    </p>
                  </div>
                </li>
